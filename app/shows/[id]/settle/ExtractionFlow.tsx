...
function ConfirmationForm({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Demo mode banner */}
      {extraction.demoMode && (
        <div className="rounded-lg border border-amber-200/80 bg-amber-50/60 px-4 py-3 flex items-start gap-3">
          <AlertTriangle className="h-4 w-4 text-amber-700 mt-0.5 shrink-0" />
          <p className="text-[12px] text-amber-800 leading-snug">
            <span className="font-semibold">Demo mode</span> — extraction result is simulated. In production, this is generated by Claude (<span className="font-mono">claude-sonnet-4-20250514</span>) reading the deal notes in real time.
          </p>
        </div>
      )}
